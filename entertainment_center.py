...
# initiating instances of class Movie
...
The_Notebook = media.Movie('The Notebook',
	...
	'http://nicholassparks.com/wp-content/uploads/2013/07/200406-the-notebook.jpeg',#noqa
...
Coherence = media.Movie('Coherence',
	...
	'https://images-na.ssl-images-amazon.com/images/M/MV5BNzQ3ODUzNDY2M15BMl5BanBnXkFtZTgwNzg0ODY2MTE@._V1_UX182_CR0,0,182,268_AL_.jpg',#noqa
...
Lock_Stock_And_Two_Smoking_Barrels = media.Movie('Lock, Stock and Two Smoking Barrels',
	'''
	A botched card game triggers four friens, thugs, weed-growers, hard gangsters, loan sharks and debt collectors
	to collide with each other in a series of unexpected events
	''',
	'https://images-na.ssl-images-amazon.com/images/M/MV5BMTAyN2JmZmEtNjAyMy00NzYwLThmY2MtYWQ3OGNhNjExMmM4XkEyXkFqcGdeQXVyNDk3NzU2MTQ@._V1_UX182_CR0,0,182,268_AL_.jpg',#noqa
	'https://www.youtube.com/watch?v=Y8MXn5No1Jc')

The_Avengers = media.Movie('The Avengers',
	'Superheroes protecting our planet',
	'https://i.annihil.us/u/prod/marvel/i/mg/6/50/521f70b81f7d3/portrait_incredible.jpg',#noqa
...
Jurassic_World = media.Movie('Jurassic World',
	...
	'http://cdn.playbuzz.com/cdn/fcbb825b-b56f-411a-9512-f9b70198c672/f478eb4c-210c-4656-90b6-ce640beff119.jpg',#noqa
	'https://www.youtube.com/watch?v=RFinNxS5KN4')

#storing instance names in a movies list
...
#open page of movies in the movies list
